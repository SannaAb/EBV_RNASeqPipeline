...
#FirstAnno=NC_007605.1-20210315_NC_changedforstrandedsequencing.tsv
FirstAnno=""
...
$featureCounts -a $FirstAnno -M -s 2 -J -p -t exon --Rpath NewCounts/ -R BAM -g gene -o NewCounts/$1.counts EBV_Alignment/$1_KeptEBER.3Missmatch_40nt_10Multimapped.EBV.bam
...
$featureCounts -a $SecondAnno -M -s 2 -J -p -t exon -g gene -o NewCounts/$1.Genecounts NewCounts/$1_unassigned_sorted.bam
...
cat NewCounts/$1_Merge_unassigned_FeatureCounts.txt Human_counts/$1.3Missmatch_40nt_10Multimapped.Human_count > NewCounts/$1_HV.count
